...
%hypothèses prises pour Co(acac)3
%On part des poynomes NASA du ligand acac seul
%La molécule complète a un Cp et un S de 3x Cp et S du ligand acac %(https://rmg.mit.edu/database/thermo/libraries/CHO/106/)
%Le deltaH de formation de acac et Co(acac)3 sont connus (Inorg.Chem.2025,64,21405−21418)
%On intégre H à partir du Cp(T) avec le deltaH de formation réel de Co(acac)3
%Pour Co(acac)3, on remarque que le deltaHf de Co(acac)3 est à peu près 3x %celui du ligand acac

deltaHf=-267.6; %kcal.mol-1, valeur réelle pour Co(acac3)
Nb_ligand=3;
deltaHf_new=deltaHf*1000*cal %J/moles
