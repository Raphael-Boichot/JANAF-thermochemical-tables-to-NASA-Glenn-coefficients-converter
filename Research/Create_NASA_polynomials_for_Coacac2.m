...
Low_temp_threshold=200;            %Low temperature threshold for cutting temperature search
High_temp_threshold=2000;           %High temperature threshold for cutting temperature search
resampling_T=20;                     %temperature steps for resampling and cutting temp search
...
T_exp=T_exp';
H_R_exp=interp1(T_exp_raw,H_R_exp_raw,T_exp,"linear");
Cp_R_exp=interp1(T_exp_raw,Cp_R_exp_raw,T_exp,"linear");
S_R_exp=interp1(T_exp_raw,S_R_exp_raw,T_exp,"linear");
...
for Cutting_temperature=Low_temp_threshold:resampling_T:High_temp_threshold
    ...
    x_0 = [1 1e-2 1e-7 1e-11 1e-13];%some realistic starting values
    ...
    x_0 = -100;%some random starting value
